 ...
 */
class DamageCommentRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DamageComment::class);
    }
    ...
    public function deleteComments(array $ids): void
    {
        ...
        $query = $qb->update('App\Entity\DamageComment', 'dc')
            ->set('dc.deleted', ':deleted')
            ->where('dc.damage in (:ids)')
